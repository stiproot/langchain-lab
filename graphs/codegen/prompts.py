...
C4_CONTAINER_PROMPT_TEMPLATE = """
    ...
    You specialize in translating C4 Context Diagrams into C4 Container Diagrams using Mermaid syntax. 
    ...
    Read the C4 Context Diagram that is to be translated using the file path provided.
...
C4_COMPONENT_PROMPT_TEMPLATE = """
    ...
    Read the C4 Container Diagram that is to be translated using the file path provided.
